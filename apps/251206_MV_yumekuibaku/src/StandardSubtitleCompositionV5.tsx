...
import { FloatingSubtitleV5 } from './FloatingSubtitleV5';
import { z } from 'zod';

// Define props schema
export const standardSubtitleV5Schema = z.object({
...
export const StandardSubtitleCompositionV5: React.FC<z.infer<typeof standardSubtitleV5Schema>> = ({
    fontSize,
    color,
    letterSpacing,
    animationSpeed,
