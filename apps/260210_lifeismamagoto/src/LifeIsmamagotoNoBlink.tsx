...
// コンポジション全体のスキーマ
export const lifeIsmamagotoNoBlinkSchema = z.object({
...
export type LifeIsmamagotoNoBlinkProps = z.infer<typeof lifeIsmamagotoNoBlinkSchema>;

export const LifeIsmamagotoNoBlink: React.FC<LifeIsmamagotoNoBlinkProps> = ({
  bgLayer,
  yuiLayer,
  effectIntensity,
  effectSpeed,
